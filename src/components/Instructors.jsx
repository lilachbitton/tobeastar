...
const instructorsData = [
  ...
  {
    name: 'יוני חרל"פ',
    role: ' איש קריאייטיב מהבולטים בארץ, במאי ויוצר תוכן שמלווה טאלנטים וארגונים להצלחה בסושיאל עם סרטונים של מאות מיליוני צפיות.
מהמקימים של הערוץ ״קווין רובין״ העורך הראשי של הבנים והבנות',
